...
variable "monitoring_accounts_id" {
  type        = list(string)
  description = "List of account ids of monitored accounts"
}

variable "security_group" {
  type        = string
  description = "Security group for Lambda send to ALB"
}

variable "loki_url" {
  type        = string
  description = "Loki alb name to send logs to loki"
}
